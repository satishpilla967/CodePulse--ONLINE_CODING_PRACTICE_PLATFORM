...
export default function SchoolEmail({
  linkUrl = "https://codepulse.patinanetwork.org",
}: SchoolEmailProps) {
  return (
    <Html
      style={{
    ...
    >
      <Head />
      <Preview>Confirm your email to activate your CodePulse account</Preview>
      <Tailwind>
          ...
          <Container className="mx-auto p-0 max-w-[560px]">
            ...
            <Row align="center">
              <Column align="left" className="w-[64px]">
                <Img
                  src="https://codepulse.patinanetwork.org/logo.png"
                  alt="CodePulse"
                  width={64}
                  height={64}
                  style={{ display: "block" }}
