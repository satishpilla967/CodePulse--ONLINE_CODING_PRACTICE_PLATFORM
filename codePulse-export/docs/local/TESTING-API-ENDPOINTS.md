...
1. Ensure that you deployed your changes to staging within your PR ([read more here](https://github.com/tahminator/codepulse/wiki/GitHub-Actions#how-to-trigger-deployment)).
...
1. Inside the input box, enter the following link:
    ...
    ```
    https://stg.codepulse.patinanetwork.org/v3/api-docs

    # or if you're testing things locally
    http://localhost:8080/v3/api-docs

    # or prod
    https://codepulse.patinanetwork.org/v3/api-docs
    ```
...
1. You can then hit `Import` and rename the new collection to indicate the environment (e.g. `CodePulse dev` or `CodePulse stg`)
...
1. Enter in `stg.codepulse.patinanetwork.org` (or local/prod) into the domain list
...
1. Navigate to [stg.codepulse.patinanetwork.org](https://stg.codepulse.patinanetwork.org) (or local/prod) and log in as you normally would (if you are logged in, log out then log back in).
