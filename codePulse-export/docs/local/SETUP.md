...
> **NOTE**: If you open the codepulse repository in VSCode, it will prompt you to install recommended extensions to the workspace, which will include everything below.
...
[.vscode/](https://github.com/tahminator/codepulse/tree/main/.vscode) defines some workspace defaults to help make development consistent.
...
There is a [.lazy.lua](https://github.com/tahminator/codepulse/tree/main/.lazy.lua) file in the root directory that will apply some default, but only for `LazyVim`. Of course, you can replicate the behavior in your own distribution (and create a pull request with the changes).
