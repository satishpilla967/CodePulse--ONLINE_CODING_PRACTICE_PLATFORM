...
> [!NOTE]
> Please reach out to [@tahminator](https://github.com/tahminator) if you are on the CodePulse dev team & need the credentials to login & view the dashboard
...
```
https://stg.codepulse.patinanetwork.org/actuator/prometheus
```

**Production:**

```
https://codepulse.patinanetwork.org/actuator/prometheus
```
