...
<p align="center">
    <i>
        Generated with <code>mermerd -c=postgresql://postgres:passwordnomas@localhost:5432/codepulse-dev-2 -s=public --outputMode=stdout --useAllTables --showDescriptions enumValues,columnComments,notNull</code>
    </i>
</p>
<p align="center">
    <i>
