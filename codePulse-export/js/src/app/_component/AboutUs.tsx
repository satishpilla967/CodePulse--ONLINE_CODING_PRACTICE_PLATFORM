import CategoryButtons from "@/app/_component/CategoryButtons";
import LanguageCards from "@/app/_component/LanguageCards";
      ...
      <Flex h={"80vh"} w={"100%"} hiddenFrom="lg">
        <Stack align={"center"} justify={"center"} h={"100%"} w={"100%"}>
          <Badge
            ...
            m={"md"}
          >
            Celebrating CodePulse's 1 Year Anniversary! 🎉
          </Badge>
