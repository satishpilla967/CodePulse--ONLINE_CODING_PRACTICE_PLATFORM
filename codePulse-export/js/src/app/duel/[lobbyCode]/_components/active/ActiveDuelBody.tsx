...
export default function DuelActiveBody({
  ...
  // Duels currently assign a single active problem per lobby at a time.
  const activeProblemId = questions[0]?.id;
...
function SubmitModal({
  ...
  return (
    ...
    >
      ...
      : <Text c="dimmed">No active problem to submit for yet.</Text>}
    </Modal>
  );
}
