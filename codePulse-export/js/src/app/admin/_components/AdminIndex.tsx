...
import NewProblemModal from "@/app/admin/_components/problems/NewProblemModal";
import ProblemAdminList from "@/app/admin/_components/problems/ProblemAdminList";
...
export default function AdminIndex() {
  return (
    <Flex w={"98vw"} mih={"100vh"} direction={"column"}>
      ...
      <Flex w={"100%"} direction={"column"} ta={"center"} m={"sm"}>
        <Title order={4}>Judge Problems</Title>
        <Flex w={"100%"} direction={"row"} justify={"center"}>
          <NewProblemModal />
        </Flex>
        <ProblemAdminList />
