...
describe("LeaderboardSkeleton succeeded", () => {
  ...
  it("should render visit codepulse button when embedded", () => {
    renderProviderFn?.(<LeaderboardSkeleton embedded />);
    const element = screen.getByTestId(
      "leaderboard-skeleton-visit-codepulse-button",
    );
    expect(element).toBeInTheDocument();
    expect(element).toBeVisible();
  });
  ...
  it("should not render visit codepulse button when not embedded", () => {
    renderProviderFn?.(<LeaderboardSkeleton />);
