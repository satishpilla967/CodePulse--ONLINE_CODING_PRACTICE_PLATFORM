# CodePulse Standup Bot

CodePulse Standup Bot is an internal application written in [Rust](https://rust-lang.org/) & [Tokio](https://tokio.rs/) that houses the logic required to send the CodePulse development team's daily standup message.
...
- The [`./Dockerfile`](./Dockerfile) is used to build an image, which is uploaded to [hub.docker.com/r/tahminator/codepulse-standup-bot](https://hub.docker.com/r/tahminator/codepulse-standup-bot)
