package org.patinanetwork.codepulse.api;
...
import org.patinanetwork.codepulse.utilities.ServerMetadataObject;
import org.patinanetwork.codepulse.utilities.sha.CommitShaProperties;
    ...
    public ResponseEntity<ApiResponder<ServerMetadataObject>> apiIndex(final HttpServletRequest request) {
        return ResponseEntity.ok()
                .body(ApiResponder.success(
                        "Hello from CodePulse!", new ServerMetadataObject(commitShaProperties.getSha())));
    }
}
