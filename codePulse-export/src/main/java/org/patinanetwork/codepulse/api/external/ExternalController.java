package org.patinanetwork.codepulse.api.external;
...
import org.patinanetwork.codepulse.common.db.models.api.ApiKey;
...
import org.patinanetwork.codepulse.common.db.repos.api.ApiKeyRepository;
import org.patinanetwork.codepulse.common.db.repos.api.access.ApiKeyAccessRepository;
...
public class ExternalController {
    ...
    public ResponseEntity<ApiResponder<List<UserWithScore>>> getGwcUsers(
        ...
        boolean hasGwcAccess =
                accesses.stream().anyMatch(access -> access.getAccess() == ApiKeyAccessEnum.GWC_READ_BY_USER);
