package org.patinanetwork.codepulse.api.user;
...
import org.patinanetwork.codepulse.api.user.body.UpdateProfileBody;
...
import org.patinanetwork.codepulse.common.db.repos.user.UserMetricsRepository;
...
import org.patinanetwork.codepulse.common.dto.user.metrics.MetricsDto;
import org.patinanetwork.codepulse.common.ff.annotation.FF;
import org.patinanetwork.codepulse.common.lag.FakeLag;
import org.patinanetwork.codepulse.common.page.Page;
...
public class UserController {
    ...
    @Operation(
            summary = "Protected route that updates the logged-in user's own profile.",
            description = """
            Updates the nickname and/or profile picture URL of the currently authenticated user.
            Fields that are omitted (null) are left unchanged.
            """,
            responses = {
    ...
    public ResponseEntity<ApiResponder<UserDto>> updateOwnProfile(
            @Protected final AuthenticationObject authenticationObject,
            @Valid @RequestBody final UpdateProfileBody body) {
        ...
        return ResponseEntity.ok().body(ApiResponder.success("Profile updated!", UserDto.fromUser(user)));
    }
}
