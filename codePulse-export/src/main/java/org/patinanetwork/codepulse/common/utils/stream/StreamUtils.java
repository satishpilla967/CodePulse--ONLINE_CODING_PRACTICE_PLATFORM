package org.patinanetwork.codepulse.common.utils.stream;
...
public class StreamUtils {
    ...
    /**
     * Creates a function that applies a side effect to an input value and returns the value unchanged.
     *
     * <p>This differs from {@link java.util.stream.Stream#peek} because the default `peek` method is intended for
     * debugging, and in some cases, may be abstracted away from the compiler.
     *
     * <p>NOTE: The order `peek` returns is not guaranteed on {@link java.util.stream.Stream#parallel()}.
     *
     * <p>*
     *
     * <pre>{@code
