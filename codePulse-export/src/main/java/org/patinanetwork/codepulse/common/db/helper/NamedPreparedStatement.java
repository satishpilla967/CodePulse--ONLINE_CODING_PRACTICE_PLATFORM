package org.patinanetwork.codepulse.common.db.helper;
...
/**
 * This class wraps around a {@link PreparedStatement} to allow named parameters instead of indexed parameters. Example:
 *
 * <p>this:
 *
 * <pre>
...
public class NamedPreparedStatement implements AutoCloseable {
    ...
    /**
     * Creates a NamedPreparedStatement. Wraps a call to c.{@link Connection#prepareStatement(java.lang.String)
     * prepareStatement}.
     *
     ...
     *
     * <p>Creates a NamedPreparedStatement. Wraps a call to c.{@link Connection#prepareStatement(java.lang.String)
     * prepareStatement}.
     *
     * @param conn the database connection
     * @param sql the parameterized query
