package org.patinanetwork.codepulse.common.email.client.codepulse;
...
import org.patinanetwork.codepulse.common.email.EmailClient;
import org.patinanetwork.codepulse.common.email.Message;
...
/**
 * This is the official CodePulse email client which we use to interface with our actual users.
 *
 * <p>For example, we use this client to send emails to users who are trying to verify their school status.
 */
@Component
@EnableConfigurationProperties(OfficialCodePulseEmailClientProperties.class)
@Timed(value = "email.client.execution")
public class OfficialCodePulseEmailClient extends EmailClient {

    private final OfficialCodePulseEmailClientProperties emailProperties;
    private Session session;

    public OfficialCodePulseEmailClient(final OfficialCodePulseEmailClientProperties emailProperties) {
