...
public final class SimpleRedisSlot<V> {
    ...
    public static final SimpleRedisSlot<Long> REPORTER_COOLDOWN = new SimpleRedisSlot<>(3, Long.class);

    public static final List<SimpleRedisSlot<?>> ALL =
            List.of(SUBMISSION_REFRESH, VERIFICATION_EMAIL_SENDING, GLOBAL_RATE_LIMIT, REPORTER_COOLDOWN);
}
