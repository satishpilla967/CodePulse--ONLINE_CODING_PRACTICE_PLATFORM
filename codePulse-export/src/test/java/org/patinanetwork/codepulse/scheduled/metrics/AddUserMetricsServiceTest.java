package org.patinanetwork.codepulse.scheduled.metrics;
...
import org.patinanetwork.codepulse.common.components.LeaderboardException;
import org.patinanetwork.codepulse.common.db.models.leaderboard.Leaderboard;
import org.patinanetwork.codepulse.common.db.models.task.BackgroundTask;
import org.patinanetwork.codepulse.common.db.models.task.BackgroundTaskEnum;
...
import org.patinanetwork.codepulse.common.db.repos.task.BackgroundTaskRepository;
...
public class AddUserMetricsServiceTest {
    ...
    void setup() {
        ...
        service = new AddUserMetricsService(backgroundTaskRepository, leaderboardRepository, userMetricsRepository);
    }
    ...
    void congregateUserMetricsSkipsWhenTodayEstSnapshotAlreadyExists() throws LeaderboardException {
        OffsetDateTime completedAfterTodayEstMidnight =
                ZonedDateTime.now(ZoneOffset.UTC).minusMinutes(1).toOffsetDateTime();
        BackgroundTask lastSync = BackgroundTask.builder()
                .task(BackgroundTaskEnum.USER_METRICS)
