...
import org.patinanetwork.codepulse.common.utils.duel.PartyCodeGenerator;
...
public class DuelManagerTest {
    ...
    private ProblemRepository problemRepository = mock(ProblemRepository.class);
    private JudgeSubmissionRepository judgeSubmissionRepository = mock(JudgeSubmissionRepository.class);
    ...
    void testGenerateDuelDataSuccess() {
        ...
        Lobby mockLobby = randomPartialLobby()
                ...
                .expiresAt(Optional.of(OffsetDateTime.now().plusHours(1)))
                .playerCount(2)
    ...
    void testGenerateDuelDataWithWinner() {
        ...
        Lobby mockLobby = randomPartialLobby()
                ...
                .expiresAt(Optional.of(OffsetDateTime.now()))
                .playerCount(2)
    ...
    @Test
    void testGenerateDuelDataThrowsNonDuelException() {
        String lobbyId = java.util.UUID.randomUUID().toString();
    ...
    void testStartDuelFailsUserIsNotInAParty() {
        ...
        verify(lobbyRepository, never()).updateLobby(any());
        verify(problemRepository, never()).getRandomProblem();
    ...
    void testStartDuelFailsLobbyDoesNotHaveEnoughPlayersButIsAdminUser() {
        ...
        when(problemRepository.getRandomProblem()).thenReturn(Optional.of(problem));
        ...
        verify(problemRepository, times(1)).getRandomProblem();
    ...
    @Test
    void testStartDuelThrowsNonDuelExceptionFromProblemRepository() {
        String userId = UUID.randomUUID().toString();
    ...
    void testGetLobbyByUserIdNoPartyFoundButDuelFound() {
        ...
        Lobby duel = Lobby.builder()
                .id(UUID.randomUUID().toString())
                .createdAt(StandardizedOffsetDateTime.now())
                .expiresAt(Optional.of(StandardizedOffsetDateTime.now()))
                .joinCode(PartyCodeGenerator.generateCode())
                .playerCount(1)
                .winnerId(Optional.empty())
                .tie(false)
    ...
    void testProcessSubmissionsLobbyGivenButNoLobbyPlayerInstanceFound() {
        ...
        verify(judgeSubmissionRepository, never()).getSubmissionsByUserAndLobbyAndProblem(any(), any(), any());
    ...
    void testProcessSubmissionsSuccessful() {
        ...
        var problem = Problem.builder().id(UUID.randomUUID().toString()).slug("two-sum").build();

        var lobbyQuestion = LobbyQuestion.builder()
                .id(UUID.randomUUID().toString())
                .lobbyId(activeLobby.getId())
                .problemId(Optional.of(problem.getId()))
                .userSolvedCount(0)
                .build();

        var acceptedSubmission = JudgeSubmission.builder()
                .id(UUID.randomUUID().toString())
                .userId(user.getId())
        ...
        when(lobbyPlayerQuestionRepository.findQuestionsByLobbyPlayerId(eq(lobbyPlayer.getId())))
                .thenReturn(List.of());
        when(judgeSubmissionRepository.getSubmissionsByUserAndLobbyAndProblem(
                        eq(user.getId()), eq(activeLobby.getId()), eq(problem.getId())))
        ...
        verify(judgeSubmissionRepository, times(1))
                .getSubmissionsByUserAndLobbyAndProblem(eq(user.getId()), eq(activeLobby.getId()), eq(problem.getId()));
    ...
    @Test
    void testProcessSubmissionsThrowsNonDuelExceptionFromLobbyQuestionRepository() {
        var user = createRandomUser();
        var activeLobby = Lobby.builder()
                .id(UUID.randomUUID().toString())
                .joinCode(PartyCodeGenerator.generateCode())
        ...
        doThrow(new RuntimeException("Simulated db exception"))
                .when(lobbyQuestionRepository)
                .findLobbyQuestionsByLobbyId(any());
    ...
    @Test
    void testProcessSubmissionsThrowsNonDuelExceptionFromJudgeSubmissionRepository() {
        var user = createRandomUser();
        var activeLobby = Lobby.builder()
                .id(UUID.randomUUID().toString())
                .joinCode(PartyCodeGenerator.generateCode())
        ...
        var lobbyQuestion = LobbyQuestion.builder()
                .id(UUID.randomUUID().toString())
                .lobbyId(activeLobby.getId())
                .problemId(Optional.of(UUID.randomUUID().toString()))
                .userSolvedCount(0)
                .build();
        ...
        when(lobbyPlayerQuestionRepository.findQuestionsByLobbyPlayerId(eq(lobbyPlayer.getId())))
                .thenReturn(List.of());
        doThrow(new RuntimeException("Simulated db exception"))
                .when(judgeSubmissionRepository)
                .getSubmissionsByUserAndLobbyAndProblem(any(), any(), any());
        ...
        verify(lobbyPlayerRepository, times(1)).findValidLobbyPlayerByPlayerId(eq(user.getId()));
        verify(lobbyQuestionRepository, times(1)).findLobbyQuestionsByLobbyId(eq(activeLobby.getId()));
        verify(judgeSubmissionRepository, times(1)).getSubmissionsByUserAndLobbyAndProblem(any(), any(), any());
        verify(lobbyPlayerQuestionRepository, never()).createLobbyPlayerQuestion(any());
        verify(lobbyPlayerRepository, never()).updateLobbyPlayer(any());
    }
}
